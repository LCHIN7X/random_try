...
int main() {
    ...
    bind(server_fd, (void*)&addr, sizeof(addr));
    listen(server_fd, 5);
    ...
    pthread_mutex_init(&game->game_mutex, &a);
    pthread_mutex_init(&game->score_mutex, &a);
